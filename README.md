# Bookstore-Management-using-MySQL

This project focuses on designing and implementing a MySQL-based database system for a retail bookstore. The project uses a books table as the core dataset and enhances it to support better data management, analytics, and reporting.

A secondary table, publishers, is added to normalize the schema and improve database structure.
